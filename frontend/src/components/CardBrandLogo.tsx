...
// Los logos van embebidos como SVG: no cuestan una petición extra, se ven
// nítidos en cualquier densidad de pantalla y no dependen de un CDN externo.
function VisaMark() {
  return (
    <svg viewBox="0 8.1 24 7.8" role="presentation" focusable="false">
...
function MastercardMark() {
  return (
    <svg viewBox="6.6 4.6 22.8 14.8" role="presentation" focusable="false">
      <circle cx="14" cy="12" r="7.2" fill="#EB001B" />
      <circle cx="22" cy="12" r="7.2" fill="#F79E1B" />
      <path
        fill="#FF5F00"
        d="M18 6.42a7.19 7.19 0 0 0 0 11.16 7.19 7.19 0 0 0 0-11.16Z"
      />
    </svg>
  );
}
